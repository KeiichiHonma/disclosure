        ...
        <div id="document">
            ...
            <table class="finance">
                <tr>
                    ...
                    <?php if($type == "pl"): ?>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'net-sales' ? 'net-salesRev' : 'net-sales').'/'.$page,'売上高'.($order == 'net-sales' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'net-salesRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'cost-of-sales' ? 'cost-of-salesRev' : 'cost-of-sales').'/'.$page,'売上原価'.($order == 'cost-of-sales' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'cost-of-salesRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'gross-profit' ? 'gross-profitRev' : 'gross-profit').'/'.$page,'売上<br />総利益'.($order == 'gross-profit' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'gross-profitRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'operating-income' ? 'operating-incomeRev' : 'operating-income').'/'.$page,'営業<br />利益'.($order == 'operating-income' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'operating-incomeRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'ordinary-income' ? 'ordinary-incomeRev' : 'ordinary-income').'/'.$page,'経常<br />利益'.($order == 'ordinary-income' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'ordinary-incomeRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'extraordinary-total' ? 'extraordinary-totalRev' : 'extraordinary-total').'/'.$page,'特別損益<br />収支'.($order == 'extraordinary-total' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'extraordinary-totalRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'net-income' ? 'net-incomeRev' : 'net-income').'/'.$page,'当期<br />純利益'.($order == 'net-income' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'net-incomeRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <?php endif; ?>
                    <?php if($type == "bs"): ?>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'assets' ? 'assetsRev' : 'assets').'/'.$page,'資産合計'.($order == 'assets' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'assetsRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'liabilities' ? 'liabilitiesRev' : 'liabilities').'/'.$page,'負債合計'.($order == 'liabilities' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'liabilitiesRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'capital-stock' ? 'capital-stockRev' : 'capital-stock').'/'.$page,'資本金'.($order == 'capital-stock' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'capital-stockRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'shareholders-equity' ? 'shareholders-equityRev' : 'shareholders-equity').'/'.$page,'株主資本'.($order == 'shareholders-equity' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'shareholders-equityRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <?php endif; ?>
                    <?php if($type == "cf"): ?>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'net-income' ? 'net-incomeRev' : 'net-income').'/'.$page,'当期<br />純利益'.($order == 'net-income' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'net-incomeRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'depreciation-and-amortization' ? 'depreciation-and-amortizationRev' : 'depreciation-and-amortization').'/'.$page,'減価償却'.($order == 'depreciation-and-amortization' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'depreciation-and-amortizationRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
                    <th class="data"><?php echo anchor('finance/'.$page_name.'/'.$object_id.'/'.$type.'/'.$year.'/'.($order == 'net-cash-provided-by-used-in-operating-activities' ? 'net-cash-provided-by-used-in-operating-activitiesRev' : 'net-cash-provided-by-used-in-operating-activities').'/'.$page,'営業CF'.($order == 'net-cash-provided-by-used-in-operating-activities' ? '<i class="fa fa-long-arrow-up"></i>' : ($order == 'net-cash-provided-by-used-in-operating-activitiesRev' ? '<i class="fa fa-long-arrow-down"></i>' : ''))); ?></th>
