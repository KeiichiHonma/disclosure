            <div id="side_cat">
                ...
                <?php if(!empty($company)): ?><li<?php if($document_side_current == 'company_show'): ?> class="current"<?php endif; ?>><a href="<?php echo '/companyh/show/'.$document->presenter_id; ?>"><span><?php echo $document->presenter_name; ?>の企業情報</span><span class="ico"><img src="/images/icon/comnpany_info_20.png" alt="omnpany_info" /></span></a></li><?php endif; ?>
                </ul>
            </div><!-- /side_cat -->
            <div class="side_list">
