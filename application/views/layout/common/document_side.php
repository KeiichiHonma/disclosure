            <div id="side_cat">
                ...
                <?php if(!empty($etc_documents)): ?><li<?php if($document_side_current == 'document_company'): ?> class="current"<?php endif; ?>><a href="<?php echo '/company/document/'.$document->edinet_id; ?>"><span><?php echo $document->presenter_name; ?>の開示情報一覧</span><span class="ico"><img src="/images/icon/presenter_documents_20.png" alt="presenter_documents" /></span></a></li><?php endif; ?>
