...
class Publisher {
    ...
    public function __construct($arg) {
        if (!isset($arg['hub_url']))
            throw new Exception('Please specify a hub url');
        
        if (!preg_match("|^https?://|i",$arg['hub_url'])) 
            throw new Exception('The specified hub url does not appear to be valid: '.$arg['hub_url']);
            
        $this->hub_url = $arg['hub_url'];
    }
